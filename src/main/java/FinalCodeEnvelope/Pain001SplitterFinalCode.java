...
public class Pain001SplitterFinalCode {

    public static void main(String[] args) throws Exception {
        File inputFile = new File("C:\\Users\\ADMIN\\OneDrive\\Desktop\\RFT\\RFT_PAIN1V9.xml");

        String groupType = "BIC"; // or "COUNTRY"
        String groupValue = "BARCGB22XXX"; // specific BIC or country code to match

        new Pain001SplitterFinalCode().splitFileByGrouping(inputFile, groupType, groupValue);
    }
    ...
    public void splitFileByGrouping(File inputFile, String groupType, String groupValue) throws Exception {
        ...
        List<Element> matchedPmtInfList = new ArrayList<>();
        ...
        if (!matchedPmtInfList.isEmpty()) {
            writeOutputFile(groupType, groupValue, matchedPmtInfList, grpHdr, originalMsgId, creDtTm);
        } else {
    ...
    private void writeOutputFile(String groupType, String keyValue, List<Element> pmtInfList,
                                 Element originalGrpHdr, String msgId, String creDtTm) throws Exception {
        ...
        String receiverBIC = "BIC".equalsIgnoreCase(groupType) ? keyValue : extractBICFromPmtInf(pmtInfList.get(0));
        String newMsgId = msgId + "_" + groupType + "_" + keyValue.replaceAll("[^a-zA-Z0-9]", "_");

        Element appHdr = createAppHdr(doc, newMsgId, creDtTm, receiverBIC);
    ...
    private Element createAppHdr(Document doc, String msgId, String creDtTm, String receiverBIC) {
        ...
        appHdr.appendChild(createTextElement(doc, "MsgDefIdr", "pain.001.001.03"));
